		...
		for (i = 0; i < levelCnt; i++) { // iterate through all levels
			...
			if (levelSegs) {
				for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
					...
					td = $('<td class="fc-event-container" data-toggle="modal" data-target="#modalCriarAlerta" />').append(seg.el);
	...
	renderSegPopoverContent: function(row, col, segs) {
		...
		var content = $(
			...
			'<div class="fc-body ' + theme.getClass('popoverContent') + '">' +
				'<div class="fc-event-container" data-toggle="modal" data-target="#modalCriarAlerta"></div>' +
			'</div>'
		);
...
TimeGrid.mixin({
	...
	renderContentSkeleton: function() {
			...
			cellHtml +=
				'<td>' +
					'<div class="fc-content-col">' +
						'<div class="fc-event-container fc-helper-container" data-toggle="modal" data-target="#modalCriarAlerta"></div>' +
						'<div class="fc-event-container" data-toggle="modal" data-target="#modalCriarAlerta"></div>' +
		...
		skeletonEl = $(
			'<div class="fc-content-skeleton" data-toggle="modal" data-target="#modalCriarAlerta">' +
				'<table>' +
					'<tr data-toggle="modal" data-target="#modalCriarAlerta">' + cellHtml + '</tr>' +
				'</table>' +
			'</div>'
		);
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content" data-toggle="modal" data-target="#modalCriarAlerta">' +
					(timeText ?
						'<div class="fc-time"' +
