    ...
    public class ReguaContatoService : IReguaContatoService
    {
        ...
        private async Task EnvioWhatsApp(ReguaContatoFila reguaContatoFila)
        {
            try
            {
                ...
                string retorno = await _whatsAppService.SendMessage(reguaContatoFila.Unidade.Contato.Token, reguaContatoFila.Aluno.Contato.Celular, mensagemBody, reguaContatoFila.Aluno.Id);
                await IncluirHistorico(reguaContatoFila, mensagemBody);
                Thread.Sleep(_appSettings.TimePauseWhatsApp);
                retorno = await _whatsAppService.SendMessage(reguaContatoFila.Unidade.Contato.Token, reguaContatoFila.Aluno.Contato.Celular, reguaContatoFila.Pagamento.NumeroLinhaDigitavel, reguaContatoFila.Aluno.Id);
