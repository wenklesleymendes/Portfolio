...
{
    public class CatracaTopDataColegioObjetivoJKApi : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioObjetivoJKApi(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
        ...
        protected override void RegistreAcessoPessoa(Pessoa pessoa, SentidoGiro sentidoDoGiro)
        {
            ...
            {
                AuditoriaLog.EscrevaErro(nameof(CatracaTopDataColegioObjetivoJKApi),ex);
            }
