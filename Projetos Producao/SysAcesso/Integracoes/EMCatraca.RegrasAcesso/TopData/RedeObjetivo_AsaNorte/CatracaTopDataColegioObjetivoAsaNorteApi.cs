...
{
    public class CatracaTopDataColegioObjetivoAsaNorteApi : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioObjetivoAsaNorteApi(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
