...
{
    class CatracaTopDataColegioObjetivoTaguatingaApi : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioObjetivoTaguatingaApi(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
        ...
        protected override void RegistreAcessoPessoa(Pessoa pessoa, SentidoGiro sentidoDoGiro)
        {
            ...
            catch (Exception ex)
            {
                LogAuditoria.Escreva("ERRO - 2 - Override",
                    nameof(CatracaTopDataColegioObjetivoTaguatingaApi));
            }
