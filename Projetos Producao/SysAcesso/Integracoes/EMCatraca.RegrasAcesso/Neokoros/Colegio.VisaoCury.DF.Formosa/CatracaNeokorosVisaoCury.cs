...
namespace EMCatraca.RegrasAcesso.Neokoros.Colegio.VisaoCury.DF.Formosa
{
    internal class CatracaNeokorosVisaoCury : CatracaNeokorosAbstract
    {
        ...
        public CatracaNeokorosVisaoCury(Dispositivo Catraca) : base(Catraca)
        {
        ...
        protected override string ObtenhaMatriculaPorRFID(string codigoRFID)
        {
            LogAuditoria.Escreva($"{nameof(ObtenhaMatriculaPorRFID)}: " +
                   ...
                   $"{nameof(CatracaNeokorosVisaoCury)}");
