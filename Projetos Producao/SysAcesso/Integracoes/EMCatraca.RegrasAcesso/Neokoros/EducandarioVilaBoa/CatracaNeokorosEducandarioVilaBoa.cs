...
namespace EMCatraca.RegrasAcesso.Neokoros.EducandarioVilaBoa
{
    internal class CatracaNeokorosEducandarioVilaBoa : CatracaNeokorosAbstract
    {
        ...
        public CatracaNeokorosEducandarioVilaBoa(Dispositivo Catraca) : base(Catraca)
        {
        ...
        //protected override Core.Dominio.RegrasAcesso RegrasAcesso { get; set; }
