...
namespace EMCatraca.RegrasAcesso.Henrry.colegiopadraoapgyn
{
    internal class CatracaHenryColegioPadrao : CatracaHenryAbstract
    {
        ...
        public CatracaHenryColegioPadrao(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
