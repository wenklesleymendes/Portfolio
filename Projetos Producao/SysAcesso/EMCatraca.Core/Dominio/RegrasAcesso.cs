...
namespace EMCatraca.Core.Dominio
{
    ...
    public class RegrasAcesso
    {
        ...
        /// <remarks>
        /// <para>Implementa Configuraçoes Customizada Tipo Acesso</para>
        /// </remarks>
        public string ExisteConfiguracoesCustomizadaTipoPessoa { get; set; }

        public List<DtoIntervalo> IntervalosAcesso { get; set; }
        ...
        public RegrasAcesso Cria()
        {
            var acesso = new RegrasAcesso
            {
                ...
                IntervalosAcesso = new List<DtoIntervalo>()
            };
