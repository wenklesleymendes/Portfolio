...
namespace Formularios.Telas.Login
{
    public partial class frmListaOperadores : Form
    {
        ...
        frmMain frmPrincipal { get; set; }

        private static readonly string acessar = "Acessar Sistema";
        ...
        private void btnLstOperdoresNovo_Click(object sender, EventArgs e)
        {
            ...
            {
                //frmCadastroOperador frm = new frmCadastroOperador(this);
                //frm.ShowDialog();
            }
        ...
        {
            //var frm = new frmCadastroOperador(this);
