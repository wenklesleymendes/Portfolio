...
OutputBaseFilename=EMCatracaConfiguracao
...
[Files]
; .NET
Source: ..\..\Binarios\EMCatraca.Configuracao.exe; DestDir: {app}\Executaveis; Flags: ignoreversion; 
Source: ..\..\Binarios\EMCatraca.Configuracao.exe.config; DestDir: {app}\Executaveis; Flags: onlyifdoesntexist
