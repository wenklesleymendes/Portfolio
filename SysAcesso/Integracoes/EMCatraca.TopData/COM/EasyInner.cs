...
namespace EasyInnerSDK
{
    ...
    public class EasyInner
    {
        ...
        /// Essa função deve ser utilizada somente com Inners Dispositivo.
        /// </summary>
        /// <param name="Inner">Número do Inner desejado.</param>
        /// <returns></returns>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        ...
        ///6 – Dispositivo com a saída liberada.
        ///7 – Dispositivo com a entrada liberada
        ///8 – Dispositivo liberada nos dois sentidos.
        ///9 – Dispositivo liberada nos dois sentidos e a marcação(registro) é gerada de acordo com o sentido do giro.</param>
        ...
        /// </summary>
        /// <param name="Funcao">0 a 9.</param>
        /// <param name="Dispositivo">0 – Não libera catraca(Default).
        ...
        /// <returns></returns>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte DefinirConfiguracoesFuncoes(byte Funcao, byte Dispositivo, byte Rele1, byte Rele2, byte Lista, byte Biometria);
        #endregion
        ...
        ///3 – entrada e saída
        ///4 – saída e entrada</param>
        /// <param name="Dispositivo">0 – reservado para uso futuro.</param>
        /// <returns></returns>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte DefinirEntradasMudancaOffLine(byte Teclado, byte Leitor1, byte Leitor2, byte Dispositivo);
        #endregion
