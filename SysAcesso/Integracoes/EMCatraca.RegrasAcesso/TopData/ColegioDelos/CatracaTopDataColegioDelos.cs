...
namespace EMCatraca.RegrasAcesso.TopData.delos
{
    public class CatracaTopDataColegioDelos : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioDelos(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
        ...
        protected override void RegistreAcessoPessoa(Pessoa pessoa, SentidoGiro sentidoDoGiro)
        {
            ...
            {
                LogAuditoria.Escreva("ERRO - 2 - Override", 
                    nameof(CatracaTopDataColegioDelos));
            }
        }
