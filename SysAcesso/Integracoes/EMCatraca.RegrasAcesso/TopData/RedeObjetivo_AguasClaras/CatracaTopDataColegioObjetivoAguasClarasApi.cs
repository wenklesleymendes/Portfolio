...
{
    public class CatracaTopDataColegioObjetivoAguasClarasApi : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioObjetivoAguasClarasApi(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
