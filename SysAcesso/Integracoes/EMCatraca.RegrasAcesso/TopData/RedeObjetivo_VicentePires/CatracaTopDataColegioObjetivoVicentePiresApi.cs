...
{
    public class CatracaTopDataColegioObjetivoVicentePiresApi : CatracaTopDataAbstract
    {
        ...
        public CatracaTopDataColegioObjetivoVicentePiresApi(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
        ...
        protected override void RegistreAcessoPessoa(Pessoa pessoa, SentidoGiro sentidoDoGiro)
        {
            ...
            {
                LogAuditoria.Escreva("ERRO - 2 - Override",nameof(CatracaTopDataColegioObjetivoVicentePiresApi));
            }
        }
