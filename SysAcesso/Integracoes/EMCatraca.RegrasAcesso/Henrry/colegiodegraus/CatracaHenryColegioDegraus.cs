...
namespace EMCatraca.RegrasAcesso.Henrry.colegiodegraus
{
    internal class CatracaHenryColegioDegraus : CatracaHenryAbstract
    {
        ...
        public CatracaHenryColegioDegraus(Dispositivo catraca, IServicoMonitorAcesso servicoMonitorAcesso) : base(catraca, servicoMonitorAcesso)
        {
