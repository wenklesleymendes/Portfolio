...
using System.Linq;
namespace EMCatraca.RegrasAcesso.ControlID.ColegioMetaBuriti
{
    public class CatracaCotrolIDColegioMetaBuritiApi : CatracaControlIDAbstract
    {
        ...
        public CatracaCotrolIDColegioMetaBuritiApi(Dispositivo dispositivo, IServicoMonitorAcesso monitorAcesso) : base(dispositivo, monitorAcesso)
        {
        ...
        protected override void RegistreAcessoPessoa(Pessoa pessoa, SentidoGiro sentidoDoGiro)
        {
            ...
            {
                AuditoriaLog.EscrevaErro(nameof(CatracaCotrolIDColegioMetaBuritiApi),ex);
            }
