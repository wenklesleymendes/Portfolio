...
export class ContratoAlunoService {
  ...
  gerarContrato(data): void {
    this.animationsService.showProgressBar(true);
    this.http.post(`${environment.baseUrl}${API.contrato.gerarContrato}`, data)
      .pipe(
  ...
  uploadContrato(data) {
    this.animationsService.showProgressBar(true);
    return this.http.post<any>(`${environment.baseUrl}${API.contrato.uploadContrato}`, data, { reportProgress: true, observe: 'events' })
      .pipe(
        map((event) => {
          switch (event.type) {
  ...
  download(id) {
    ...
    this.http.get(`${environment.baseUrl}${API.contrato.downloadContrato}`, { params })
      .pipe(
