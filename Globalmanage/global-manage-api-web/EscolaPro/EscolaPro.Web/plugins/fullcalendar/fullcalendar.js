...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (!event.allDay && seg.isStart) {
			timeHtml = '<span class="fc-time" data-toggle="modal" data-target="#modalCriarAlerta">' + htmlEscape(this.getEventTimeText(event)) + '</span>';
		}

		titleHtml =
			'<span class="fc-title" data-toggle="modal" data-target="#modalCriarAlerta">' +
