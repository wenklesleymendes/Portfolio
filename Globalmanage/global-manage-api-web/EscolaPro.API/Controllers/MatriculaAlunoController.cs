...
using EscolaPro.API.Dto.MatriculaAluno;
...
namespace EscolaPro.API.Controllers
{
    ...
    public class MatriculaAlunoController : ControllerBase
    {
        ...
        [Route("AtualizarMaterialLiberado")]
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> AtualizarMaterialLiberado([FromBody] DtoMaterialOnline materialOnline)
        {
            var retorno = await _matriculaAlunoService.AtualizarMaterialLiberado(materialOnline.MatriculaId, materialOnline.MaterialLiberado);
