...
namespace EscolaPro.Service.Interfaces.Atendimentos
{
    public interface IAtendimentoAgendamentoService
    {
        ...
        Task<DtoAtendimentoAgendamento> BuscaPorIdAtendimento(int idAtendimento);
        Task UpdateAgendamento(DtoAtendimentoAgendamento dtoAtendimentoAgendamento);
        Task<IEnumerable<Object>> FiltraAgendamentosPorData(string data);
        Task<IEnumerable<DtoAtendimentoAgendamento>> HistoricoAgendamentos(int idAtendimento);
    }
}
