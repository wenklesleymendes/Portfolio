export const API = {
    ...
    usuario: {
        ...
        buscarPorUnidade: '/api/Usuario/BuscarPorUnidade'
    },
    unidade: {
    ...
    apostilaOnline:{
      bucarApostilaPorIdMateria:'/api/ApostilaOnline/BucarApostilaPorIdMateria',
      bucarApostilaPorCursoId:'/api/ApostilaOnline/BucarApostilaPorCursoId'
    },
    alunoFinanceiroContrato: {
        ...
        baixaManual: '/api/AlunoFinanceiroContrato/BaixaManual'
    },
    contasPagar: {
    ...
    matriculaAluno: {
        ...
        atualizarMaterialLiberado: '/api/MatriculaAluno/AtualizarMaterialLiberado'
    },
    ...
    atendimento: {
        ...
        buscaIdPorNumerodeCelular: '/api/Atendimento/BuscaIdPorNumerodeCelular',
        atualizar: '/api/Atendimento/Atualizar',
        buscarAgendamentos: '/api/AtendimentoAgendamento/BuscarPorUnidade',
        buscarAgendamentosPorIdAtendimento: '/api/AtendimentoAgendamento/BuscarPorIdAtendimento',
        atualizaAgendamento: '/api/AtendimentoAgendamento/AtualizaAgendamento',
        historicoAgendamentos: '/api/AtendimentoAgendamento/HistoricoAgendamentos',
        numeroDeAtendimentos: '/api/Atendimento/BuscaNumeroDeAtendimentos',
        filtraAtndimentos: "/api/Atendimento/FiltraAtendimentos",
        editar: "/api/Atendimento/Editar"
    },
    outbound: {
        cadastrar: '/api/AtendimentoOutbound/Cadastrar',
        carregarOutbond: '/api/AtendimentoOutbound/CarregarOutbounds',
        historicoTentativa: '/api/AtendimentoOutbound/HistoricoTentativas',
        updateStatus: '/api/Atendimento/AutualizarStatus',
    },
    agendamento: {
        cadastrar: '/api/AtendimentoAgendamento/Cadastrar',
        buscarAgendamentos: '/api/AtendimentoAgendamento/BuscarPorUnidade',
        buscarAgendamentosPorIdAtendimento: '/api/AtendimentoAgendamento/BuscarPorIdAtendimento',
        atualizaAgendamento: '/api/AtendimentoAgendamento/AtualizaAgendamento',
        historicoTentativa: '/api/AtendimentoAgendamento/HistoricoTentativas',
        buscarAgendamentoPorId: '/api/AtendimentoAgendamento/BuscarPorId',
        filtraAgendamentosPorData: '/api/AtendimentoAgendamento/FiltraAgendamentosPorData'
    }
}
