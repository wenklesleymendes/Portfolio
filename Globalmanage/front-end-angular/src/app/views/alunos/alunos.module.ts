...
import { AlunoPortalParametrizacaoComponent } from './matricula-aluno/aluno-portal-parametrizacao/aluno-portal-parametrizacao/aluno-portal-parametrizacao.component';
import { ConteudoDigitalComponent } from './matricula-aluno/conteudo-digital/conteudo-digital.component';
...
@NgModule({
  declarations: [
    ...
    AlunoPortalParametrizacaoComponent,
    ConteudoDigitalComponent],
  imports: [
    CommonModule,
    HttpClientModule,
    AlunosRoutingModule,
