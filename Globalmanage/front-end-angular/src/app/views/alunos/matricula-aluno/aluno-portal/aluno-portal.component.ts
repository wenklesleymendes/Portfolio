...
export class AlunoPortalComponent implements OnInit, OnDestroy {
  ...
  gotoConteudoDigital(matriculaId: number): void {
    // src\app\views\alunos\matricula-aluno\conteudo-digital\conteudo-digital\conteudo-digital.component.html
        // this.router.navigate(['/alunos/matricula-aluno/conteudo-digital'], { state: { matriculaId } });
