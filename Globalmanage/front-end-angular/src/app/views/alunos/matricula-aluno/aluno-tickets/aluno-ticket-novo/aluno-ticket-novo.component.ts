...
@Component({
  selector: 'app-aluno-ticket-novo',
  templateUrl: './aluno-ticket-novo.component.html',
  styleUrls: ['./aluno-ticket-novo.component.scss']
})
export class AlunoTicketNovoComponent implements OnInit {
  id: number = 0;
  error: boolean = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<AlunoTicketNovoComponent>,
