...
const routes: Routes = [
  ...
  { path: 'afiliado', component: AfiliadoComponent, children: [
  ...
  { path: '', component: BodyComponent, canActivateChild: [AuthGuard], children: [
    ...
    { path: 'relatorios', canActivate: [AuthGuard], data: { aluno: false, menu: 'relatorios' },
      loadChildren: () => import('./views/relatorios/relatorios.module').then(mod => mod.RelatioriosModule) },
  ]},
