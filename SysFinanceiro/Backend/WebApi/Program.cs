...
builder.Services.AddSingleton<IInvestimentoCDBServico, InvestimentoCDBServico>();
builder.Services.AddSingleton<ISistemaFinanceiroServico, SistemaFinanceiroTeste>();
